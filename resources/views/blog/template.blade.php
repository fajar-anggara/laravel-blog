        ...
        <div class="container logo-wrap">
          <div class="row pt-5">
            <div class="col-12 text-center">
              ...
              <h1 class="site-logo"><a href="{{ url('/') }}">Example</a></h1>
            </div>
          </div>
        </div>
              ...
              <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdown05">
                    ...
                    <a class="dropdown-item" href="{{ url('blog/categories/'.$categories->id) }}">{{$categories->categori}}</a>
                    @endforeach
                  </div>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('about.web') }}">About</a>
                </li>
                <li class="nav-item">
